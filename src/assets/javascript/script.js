...
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Microsoft" class="img-fluid" style="max-height:200px" src="./src/assets/image/png/microsoft.png">' +
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
...
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Kyosera" class="img-fluid" style="max-height:150px" src="./src/assets/image/png/kyosera.png">' +
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Lenovo" class="img-fluid" style="max-height:150px" src="./src/assets/image/png/lenovo.png">' +
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
...
'                        </div>' +
'                       <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Seagate" class="img-fluid" style="max-height:150px" src="./src/assets/image/png/seagate.png">' +
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Toshiba" class="img-fluid" src="./src/assets/image/png/toshiba.png">' +
'                        </div>' +
'                        <div class="col-6 col-md-2 d-flex align-items-center justify-content-center">' +
'                            <img alt="SERVICEL PERU - Trendnet" class="img-fluid" style="max-height:130px" src="./src/assets/image/png/trendnet.png">' +
'                       </div>' +
'                    </div>' +
'                </div>' +
'            </div>' +
